...
var o23246 = temp__5455__auto__;
var temp__5455__auto____$1 = (o23246["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23247 = temp__5455__auto____$1;
return (o23247["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22358__auto__ = f;
return (o__22358__auto__["toString"]).call(o__22358__auto__);
} else {
return "";
}
}catch (e23248){var _ = e23248;
return "";
}});
...
try{var o__22358__auto___23250 = t;
(o__22358__auto___23250["cljs$lang$ctorPrWriter"]).call(o__22358__auto___23250,t,writer);
}catch (e23249){var __23251 = e23249;
}
...
var char_code = (function (){var o__22358__auto__ = (new String(char$));
return (o__22358__auto__["charCodeAt"]).call(o__22358__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22358__auto__ = String;
return (o__22358__auto__["fromCharCode"]).call(o__22358__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__23252 = num_code;
switch (G__23252) {
case (1):
return (185);
...
var o__22358__auto__ = String;
return (o__22358__auto__["fromCharCode"]).call(o__22358__auto__,superscript_code);
});
/**
...
}catch (e23254){var _e__22365__auto__ = e23254;
return false;
}})())){
...
var vec__23255 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__23255,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o23258 = temp__5455__auto__;
var temp__5455__auto____$1 = (o23258["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23259 = temp__5455__auto____$1;
return (o23259["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__23262){
var vec__23263 = p__23262;
var ns_detector = cljs.core.nth.call(null,vec__23263,(0),null);
...
var G__23269 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__23270 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__23269;
remaining_tokens = G__23270;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq23260){
...
var vec__23274 = cljs.core.split_with.call(null,(function (p1__23273_SHARP_){
return cljs.core.not_EQ_.call(null,p1__23273_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__23274,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__23274,(1),null);
...
var vec__23277 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__23277,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__23277,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__23280 = cljs.core.rest.call(null,remaining_tokens);
var G__23281 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__23280;
name_tokens = G__23281;
continue;
} else {
...
var vec__23284 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__23284,(0),null);
var arity = cljs.core.nth.call(null,vec__23284,(1),null);
var vec__23287 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__23287,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__23287,(1),null);
var vec__23290 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__23290,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__23290,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__23290,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__23290,(3),null);
...
var vec__23296 = result;
var munged_ns = cljs.core.nth.call(null,vec__23296,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__23296,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__23296,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__23296,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__23296,(4),null);
var arity = cljs.core.nth.call(null,vec__23296,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__23300 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__23300,(0),null);
var args = cljs.core.nth.call(null,vec__23300,(1),null);
var vec__23303 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__23303,(0),null);
var name = cljs.core.nth.call(null,vec__23303,(1),null);
...
var G__23306 = (arity + (1));
var G__23307 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__23308){
var vec__23309 = p__23308;
var arity = cljs.core.nth.call(null,vec__23309,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__23309,(1),null);
...
return cljs.core.get.call(null,arities,p1__23312_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__23313_SHARP_);
...
var args__4502__auto__ = [];
var len__4499__auto___23320 = arguments.length;
var i__4500__auto___23321 = (0);
while(true){
if((i__4500__auto___23321 < len__4499__auto___23320)){
args__4502__auto__.push((arguments[i__4500__auto___23321]));

var G__23322 = (i__4500__auto___23321 + (1));
i__4500__auto___23321 = G__23322;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__23316){
var vec__23317 = p__23316;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__23317,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq23314){
var G__23315 = cljs.core.first.call(null,seq23314);
var seq23314__$1 = cljs.core.next.call(null,seq23314);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23315,seq23314__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__23325__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__23325__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__23325__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__23325__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__23326 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__23326,(0),null);
var fn_name = cljs.core.nth.call(null,vec__23326,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__23326,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__23326,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__23326,(4),null);
var arity = cljs.core.nth.call(null,vec__23326,(5),null);
...
var o__22358__auto__ = f;
return (o__22358__auto__["getBasis"]).call(o__22358__auto__);
});
/**
...
}catch (e23330){var _e__22365__auto__ = e23330;
...
var G__23331 = (obj[cljs.core.first.call(null,path)]);
var G__23332 = cljs.core.rest.call(null,path);
obj = G__23331;
path = G__23332;
continue;
} else {
...
return (function (accum,p__23333){
var vec__23334 = p__23333;
var bit = cljs.core.nth.call(null,vec__23334,(0),null);
var protocol = cljs.core.nth.call(null,vec__23334,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__23337){
var vec__23338 = p__23337;
var ns = cljs.core.nth.call(null,vec__23338,(0),null);
var name = cljs.core.nth.call(null,vec__23338,(1),null);
var selector = cljs.core.nth.call(null,vec__23338,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__23343,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__23343,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__23343,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__23341_SHARP_){
return (obj[cljs.core.first.call(null,p1__23341_SHARP_)]);
});})(name,sorted_matches,vec__23343,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1553001166848
