...
var len__4499__auto___26890 = arguments.length;
var i__4500__auto___26891 = (0);
while(true){
if((i__4500__auto___26891 < len__4499__auto___26890)){
args__4502__auto__.push((arguments[i__4500__auto___26891]));

var G__26892 = (i__4500__auto___26891 + (1));
i__4500__auto___26891 = G__26892;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq26887){
...
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26888,G__26889,seq26887__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__26893_SHARP_){
return !((cljs.core.meta.call(null,p1__26893_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__26894__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e26898){var _e__25878__auto__ = e26898;
return false;
}})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
}catch (e26900){var _e__25878__auto__ = e26900;
return false;
}}
})())){
...
var _STAR_current_state_STAR_26902 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__26903 = opts;
...
var markup_db = cljs.core.get.call(null,map__26903__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_26902;
}});
...
;
var temp__5455__auto___26907 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___26907)){
var managed_print_level_26908 = temp__5455__auto___26907;
var _STAR_print_level_STAR_26906_26909 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_26908;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_26906_26909,managed_print_level_26908,temp__5455__auto___26907,writer,opts,job_fn){
return (function (p1__26905_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__26905_SHARP_,null);
});})(_STAR_print_level_STAR_26906_26909,managed_print_level_26908,temp__5455__auto___26907,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_26906_26909;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1556800402999
